...
static const std::unordered_map<Result, std::unordered_map<Result, const char *>> ERR_LOOKUP({
	...
	},
	{
		RM_AM, {
			...
			{ 53  , "Insuffucient free space on SD Card / NAND" },
			{ 101 , "Error type -1"                             },
			{ 102 , "Error type -2"                             },
			{ 103 , "Error type -3"                             },
			{ 104 , "Error type -4"                             },
	...
	{
		ctr::vfs::RM_CTR_VFS, {
			{ ctr::vfs::Error::VFS_MAGIC_MISMATCH, "Magic mismatch"           },
			{ ctr::vfs::Error::VFS_DATA_TOO_SHORT, "Data too short"           },
			{ ctr::vfs::Error::VFS_OUT_OF_BOUNDS, "Out of bounds"             },
			{ ctr::vfs::Error::VFS_END_OF_FILE, "End of file"                 },
			{ ctr::vfs::Error::VFS_UNSUPPORTED_VERSION, "Unsupported version" },
			{ ctr::vfs::Error::VFS_NOT_FOUND, "Not found"                     },
			{ ctr::vfs::Error::VFS_SHORT_IO, "Short I/O"                      },
		}
	},
	{
		RM_APPLICATION, {
			{ 0 , "Attempted installation of New 3DS exclusive content" },
			{ 1 , "Cancelled"                                           },
			{ 2 , "Insuffucient free space on SD card / NAND"           },
			...
			{ 19, "I/O Error while dumping DSP firmware"                },
			...
			{ 25, "CIA write returned short write"                       },
		}
	},
});
...
// #define LOAD(name) summary = str::error_##name##_summary; help = str::error_##name##_description
// 	str::type summary, help;
// 	switch(code)
// 	{
// 	/*
// 		TODO:
...
// 	ui::builder<ui::Text>(ui::Screen::top, str::error_occurred)
// 		.size(0.70f)
// 		.y(20.0f).x(20.0f)
...
// 	ui::builder<ui::Text>(ui::Screen::bottom, str::press_b_continue)
// 		.x(20.0f).y(35.0f)
// 		.add_to(queue);
