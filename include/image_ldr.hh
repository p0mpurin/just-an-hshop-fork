...
void load_smdh_icon(C2D_Image *ret, const ctr::smdh::SMDH& smdh, SMDHIconType type,
	unsigned int *chosenDimensions = nullptr);
void load_abgr8(C2D_Image *image, u32 *data, u16 w, u16 h, bool allocStructs = true);
